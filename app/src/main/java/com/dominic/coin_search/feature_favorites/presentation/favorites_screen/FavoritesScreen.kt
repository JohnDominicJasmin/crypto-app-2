...
import com.dominic.coin_search.feature_favorites.presentation.favorites_screen.components.FavoriteAddButton
import com.dominic.coin_search.feature_favorites.presentation.favorites_screen.components.FavoriteCoinItem
import com.dominic.coin_search.feature_favorites.presentation.favorites_screen.components.FavoriteNewsItem
import com.dominic.coin_search.feature_favorites.presentation.favorites_screen.components.FavoriteToggleButton
                    ...
                    if (isCoinSelected) {
                        items(filteredCoins, key = { it.id }) { coin ->
                            FavoriteCoinItem(
                                ...
                                onDeleteClick = {
                                    favoritesViewModel.onEvent(FavoritesEvent.DeleteCoin(coin))
                                }
                            )
                        }
                    } else {
                        items(filteredNews, key = { it.id }) { news ->
                            FavoriteNewsItem(
                                ...
                                onDeleteClick = {
                                    favoritesViewModel.onEvent(FavoritesEvent.DeleteNews(news))
                                }
                            )
                        }
